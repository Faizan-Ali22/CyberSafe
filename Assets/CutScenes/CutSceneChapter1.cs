...
public class CutSceneChapter1 : MonoBehaviour
{
    ...
    [SerializeField] public string sceneName = "Start-Attack";
    
    // Optional: Use scene index instead of name
    [SerializeField] private bool useSceneIndex = true;
    [SerializeField] public int sceneIndex= 8;
    ...
    private void MarkChapterProgress()
    {
        ...
        {
            Debug.LogWarning("CutSceneChapter1: ProgressManager instance not found.");
            return;
        }
